      ...
      <ul>
        <li>Where is the input and the output?
          <p>Your program shall read input from stdin('Standard Input') and write output to stdout('Standard Output').
            ...
            User programs are not allowed to open and read from/write to files, you will get a
            <code>Runtime Error</code>
            if you try to do so.
          </p>
        </li>
        <li>What does the execution time displayed for my submission mean?
        <p>Codechef might test your code multiple times with different input files.
