    ...
    <el-col :span=17 :offset=1>
      <el-card>
        <div slot="header">
          ...
          <el-button type="primary" icon="search" size="small" class="float_right" @click="getProblemList(1)">Search
          </el-button>
      ...
      <el-table v-loading="problemLoading" element-loading-text="loading" :data="problemList" style="width: 100%"
                stripe>
        ...
        <el-table-column label="Title">
          <template scope="scope">
            <router-link :to="{name: 'problem-details', params: {id: scope.row.id}}">{{ scope.row.title}}
            </router-link>
          </template>
        </el-table-column>
