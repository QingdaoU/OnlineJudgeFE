export const m = {
  ...
  // What_is_the_meaning_of_submission_execution_time_answer: '저희 서비스는 여러번의 case로 입력로 여러 번 넣어가면서 코드를 테스트할 수 있습니다. 코드가 각 입력 제한 시간 내에 정답을 제공할 경우 표시되는 실행 시간은 각 테스트 사례에 소요되는 최대 시간입니다. 그렇지 않으면 실행 시간이 무의미해집니다.',
  ...
  About_presentation_error: 'presentation error 란?',
