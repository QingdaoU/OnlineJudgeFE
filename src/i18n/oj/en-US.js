export const m = {
  ...
  Time_Limit_Exceeded_Description: 'The CPU time your program used has exceeded the limit.',
  Memory_Limit_Exceeded_Description: 'The memory your program actually used has exceeded the limit.',
  System_Error_Description: 'Oops, something has gone wrong with the judger. Please report this to the administrator.',
  // ACMContestRank.vue
  Menu: 'Menu',
  Chart: 'Chart',
